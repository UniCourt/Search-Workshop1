...
from src.utils.utils_postgres import set_connection, load_data
...
class Extract:
    ...
    def insert_customer_data(self):
        ...
        customer = pd.read_csv(filepath_or_buffer='olist_customers_dataset.csv')
    ...
    def insert_seller_data(self):
        ...
        seller_df = pd.read_csv(filepath_or_buffer='olist_sellers_dataset.csv')
    ...
    def insert_product_data(self):
        ...
        products_df = pd.read_csv(filepath_or_buffer='olist_products_dataset.csv',
    ...
    def insert_order_data(self):
        ...
        order_df = pd.read_csv(filepath_or_buffer='olist_orders_dataset.csv',
    ...
    def insert_order_items_data(self):
        ...
        order_items_df = pd.read_csv(filepath_or_buffer='olist_order_items_dataset.csv',
                                     na_filter=True)
